...
$(document).ready(function() {
  ...
  $("#controllerGrid").on("click", function() {
    ...
    if (document.title == "UOCFLIX | Index") {
      index();
    } else if (document.title == "UOCFLIX | Genres") {
      genres();
    } else {
            ...
            $.each(movies, (index, movie) => {
              ...
              <div class="col-lg-3 col-sm-6">
                <a onclick="selectMovie(${movie.id})" class="card text-center">
                  <img onError="this.onerror=null;this.src='/imgs/noimage.jpg';" src="https://image.tmdb.org/t/p/w500${
                    movie.poster_path
                  }">
                  <h5>${movie.title}</h5>
                </a>
        ...
        $.each(images, (index, image) => {
          output += `
            <div class="col-lg-3 col-sm-6 ">
                ...
                onError="this.onerror=null;this.src='/imgs/noimage.jpg';" src="https://image.tmdb.org/t/p/w500${
                  image.file_path
                }">
            </div>
          `;
          ...
          output1 += `
            <div class="col-lg-3 col-md-6">
              <div class="card text-center">
                <img onError="this.onerror=null;this.src='/imgs/noimage.jpg';" 
